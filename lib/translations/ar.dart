...
class Ar {
  static const Map<String, String> translations = {
    ...
    'chat_with_vendor': 'محادثة مع التاجر',
    ...
    'no_conversations_subtitle': 'ابدأ المحادثة مع التجار',
    'no_messages': 'لا توجد رسائل بعد',
    'no_messages_subtitle': 'ابدأ المحادثة',
    ...
    'delete_message_confirmation': 'هل أنت متأكد من حذف هذه الرسالة؟',
    ...
    'conversation_unarchived': 'تم إلغاء أرشفة المحادثة',
    'conversation_muted': 'تم كتم المحادثة',
    'conversation_unmuted': 'تم إلغاء كتم المحادثة',
    'conversation_added_to_favorites': 'تمت الإضافة للمفضلة',
    'conversation_removed_from_favorites': 'تمت الإزالة من المفضلة',
    ...
    'image_message': 'صورة',
    'file_message': 'ملف',
    'location_message': 'موقع',
    'video_message': 'فيديو',
    'audio_message': 'صوت',
    'unknown_message_type': 'نوع رسالة غير معروف',
    'tap_to_retry': 'اضغط للمحاولة مرة أخرى',
    ...
    'vibration_enabled': 'الاهتزاز مفعل',
    'chat_wallpaper': 'خلفية المحادثة',
    'font_size': 'حجم الخط',
    'small': 'صغير',
    'medium': 'متوسط',
    'large': 'كبير',
    ...
    'block_user_confirmation': 'هل أنت متأكد من حظر هذا المستخدم؟',
    'unblock_user_confirmation': 'هل أنت متأكد من إلغاء حظر هذا المستخدم؟',
    'user_blocked': 'تم حظر المستخدم بنجاح',
    'user_unblocked': 'تم إلغاء حظر المستخدم بنجاح',
    'user_reported': 'تم الإبلاغ عن المستخدم بنجاح',
    'contact_vendor': 'تواصل مع التاجر',
    'contact_customer': 'تواصل مع العميل',
    'view_profile': 'عرض الملف الشخصي',
    'share_contact': 'مشاركة جهة اتصال',
    ...
    'links': 'الروابط',
    'files': 'الملفات',
    'search_in_chat': 'البحث في المحادثة',
    ...
    'media_count': 'وسائط ({count})',
    'links_count': 'روابط ({count})',
    'files_count': 'ملفات ({count})',
    'view_all_media': 'عرض جميع الوسائط',
    'view_all_links': 'عرض جميع الروابط',
    'view_all_files': 'عرض جميع الملفات',
    'download_file': 'تحميل الملف',
    'open_file': 'فتح الملف',
    'share_file': 'مشاركة الملف',
    'file_downloaded': 'تم تحميل الملف بنجاح',
    'file_download_failed': 'فشل في تحميل الملف',
    'file_shared': 'تم مشاركة الملف بنجاح',
    'file_share_failed': 'فشل في مشاركة الملف',
    'message_copied': 'تم نسخ الرسالة إلى الحافظة',
    'link_copied': 'تم نسخ الرابط إلى الحافظة',
    'contact_shared': 'تم مشاركة جهة الاتصال بنجاح',
    'location_shared': 'تم مشاركة الموقع بنجاح',
    'select_contact': 'اختر جهة اتصال',
    'select_location': 'اختر موقع',
    'select_file': 'اختر ملف',
    'select_image': 'اختر صورة',
    'select_video': 'اختر فيديو',
    'select_audio': 'اختر صوت',
    'recording_voice_note': 'جاري تسجيل الرسالة الصوتية...',
    'tap_to_record': 'اضغط للتسجيل',
    'release_to_send': 'ارفع للإرسال',
    'slide_to_cancel': 'اسحب للإلغاء',
    'voice_note_duration': 'المدة: {duration}',
    'voice_note_too_short': 'الرسالة الصوتية قصيرة جداً',
    'voice_note_too_long': 'الرسالة الصوتية طويلة جداً',
    'permission_required': 'إذن مطلوب',
    'camera_permission_required': 'إذن الكاميرا مطلوب لالتقاط الصور',
    'microphone_permission_required':
        'إذن الميكروفون مطلوب لتسجيل الرسائل الصوتية',
    'storage_permission_required': 'إذن التخزين مطلوب للوصول للملفات',
    'location_permission_required': 'إذن الموقع مطلوب لمشاركة الموقع',
    'grant_permission': 'منح الإذن',
    'permission_denied': 'تم رفض الإذن',
    'permission_denied_forever':
        'تم رفض الإذن نهائياً. يرجى تفعيله من الإعدادات.',
    'go_to_settings': 'اذهب للإعدادات',
    'chat_backup': 'نسخ احتياطي للمحادثات',
    'backup_chats': 'إنشاء نسخة احتياطية',
    'restore_chats': 'استعادة المحادثات',
    'backup_created': 'تم إنشاء النسخة الاحتياطية بنجاح',
    'backup_restored': 'تم استعادة المحادثات بنجاح',
    'backup_failed': 'فشل في إنشاء النسخة الاحتياطية',
    'restore_failed': 'فشل في استعادة المحادثات',
    'export_chat': 'تصدير المحادثة',
    'export_chat_successful': 'تم تصدير المحادثة بنجاح',
    'export_chat_failed': 'فشل في تصدير المحادثة',
    'clear_chat_history': 'مسح تاريخ المحادثة',
    'clear_chat_confirmation':
        'هل أنت متأكد من مسح جميع الرسائل في هذه المحادثة؟ لا يمكن التراجع عن هذا الإجراء.',
    'chat_history_cleared': 'تم مسح تاريخ المحادثة بنجاح',
    'clear_all_chats': 'مسح جميع المحادثات',
    'clear_all_chats_confirmation':
        'هل أنت متأكد من مسح جميع المحادثات؟ لا يمكن التراجع عن هذا الإجراء.',
    'all_chats_cleared': 'تم مسح جميع المحادثات بنجاح',
    'chat_theme': 'مظهر المحادثة',
    'default_theme': 'المظهر الافتراضي',
    'dark_theme': 'المظهر الداكن',
    'light_theme': 'المظهر الفاتح',
    'custom_theme': 'مظهر مخصص',
    'chat_privacy': 'خصوصية المحادثة',
    'read_receipts': 'إيصالات القراءة',
    'typing_indicators': 'مؤشرات الكتابة',
    'last_seen_privacy': 'خصوصية آخر ظهور',
    'profile_photo_privacy': 'خصوصية صورة الملف الشخصي',
    'status_privacy': 'خصوصية الحالة',
    'blocked_users': 'المستخدمون المحظورون',
    'blocked_users_list': 'قائمة المستخدمين المحظورين',
    'no_blocked_users': 'لا يوجد مستخدمون محظورون',
    'unblock': 'إلغاء الحظر',
    'chat_security': 'أمان المحادثة',
    'end_to_end_encryption': 'التشفير من طرف لطرف',
    'encryption_info': 'الرسائل محمية بتشفير من طرف لطرف',
    'security_notice': 'إشعار أمني',
    'security_notice_text':
        'رسائلك محمية بتشفير من طرف لطرف. فقط أنت والمستقبل يمكنهما قراءتها.',
    'chat_help': 'مساعدة المحادثة',
    'chat_faq': 'الأسئلة الشائعة',
    'contact_support': 'تواصل مع الدعم',
    'report_problem': 'الإبلاغ عن مشكلة',
    'chat_tutorial': 'دروس المحادثة',
    'learn_more': 'اعرف المزيد',
    'chat_features': 'ميزات المحادثة',
    'chat_guide': 'دليل المحادثة',
    ...
    'contact_our_support': 'تواصل مع فريق الدعم',
    'chat_version': 'إصدار المحادثة',
    'update_available': 'تحديث متاح',
    'update_chat': 'تحديث المحادثة',
    ...
    'vendor_admin_zone_social_links': 'روابط التواصل',
    'vendor_admin_zone_social_links_desc':
        'إدارة روابط التواصل والعمل والمواقع الاجتماعية',
    ...
    'social_links_management': 'إدارة روابط التواصل',
    ...
    'search_for_vendors': 'البحث عن التجار',
    'search_vendors_hint': 'ابحث عن المتاجر والتجار',
