-- =====================================================
-- سكريبت إنشاء Views للصفحة الرئيسية (محدث نهائياً)
-- Homepage Views Creation Script (Final Updated)
-- =====================================================
...
-- =====================================================
-- انتهاء سكريبت Views الصفحة الرئيسية المحدث نهائياً
-- End of Final Updated Homepage Views Script
-- =====================================================
